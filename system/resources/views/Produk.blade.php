  ...
  <div class="container">
    <div class="row">
      <div class="col">
        ...
        <img src="Buket bunga.jpg" class="card-img-top" alt="...">
        <div class="card-body">
          <h5>Buket bunga</h5>
      ...
      <div class="col">
        <div class="card" style="width: 15rem;">
        <img src="bu.jpg" class="card-img-top" alt="...">
        <div class="card-body">
          <h5>Buket Bunga</h5>
                  <button type="button" class="btn btn-warning">Detail</button>
      ...
      <div class="col">
        <div class="card" style="width: 15rem;">
        <img src="tulip.JPEG" class="card-img-top" alt="...">
        <div class="card-body">
          <h5>Bunga Tulip</h5>
                <button type="button" class="btn btn-warning">Detail</button>
        
      <button type="button" class="btn btn-info">Rp. 400.000</button>
      <i class="fas fa-star"></i>
        <i class="fas fa-star"></i>
        <i class="fas fa-star"></i>
        <i class="far fa-star"></i>
      ...
      <div class="col">
        <div class="card" style="width: 15rem;">
        <img src="an.png" class="card-img-top" alt="...">
        <div class="card-body">
          <h5>Bunga Anggrek</h5>
                  <button type="button" class="btn btn-warning">Detail</button>
        
      <button type="button" class="btn btn-info">Rp. 300.000</button>
      <i class="fas fa-star"></i>
        <i class="fas fa-star"></i>
        <i class="fas fa-star"></i>
        <i class="far fa-star"></i>
